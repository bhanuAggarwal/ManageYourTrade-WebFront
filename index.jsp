...
<%
  ...
  if(session.getAttribute("ca_id") != null || session.getAttribute("superAdmin") != null){
    if(session.getAttribute("ca_id") != null){
      site = new String("./html/ca.jsp");
    }
    else{
      site = new String("http://localhost:8080/myt-admin/html/superAdmin.jsp"); 
    }
